...
class DemoGatlingPutUser extends Simulation {
 ...
 val scn = scenario("Users test Update")
     .pause(5)
     .exec(updateUser)
...
//mvn gatling:test -Dgatling.simulationClass=microservice.DemoGatlingPutUser